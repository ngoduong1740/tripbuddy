...
const CardPlaceContent = ({ ...props }: DestinationContent) => {
    return (
        <CardContent className="flex mb-6">
            <div className="">
                <img
            ...
            <div className="">
                ...
                <h3 className="text-xl font-bold font-serif text-[#397D54]">{props.title}</h3>
                <p className="description">{props.description}</p>
                <Link className="text-base font-semibold font-serif text-[#397D54] items-end" to={props.linkTarget}>{props.linkContent}</Link>
            </div>
        </CardContent>
    )
}
